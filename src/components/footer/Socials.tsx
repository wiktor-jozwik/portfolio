...
const Socials = () => {
  return (
    <div className='fill-white flex flex-row space-x-10'>
      <Link href='https://github.com/wiktor-jozwik' passHref={true}>
        <svg
      ...
      <Link href='https://t.me/jozek09' passHref={true}>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          x='0px'
          y='0px'
      ...
      <Link href='mailto:wiktorjozwik99@gmail.com' passHref={true}>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          x='0px'
          y='0px'
